...
def solve_pullcubetool_can(env: PullCubeToolEnv_can, seed=None, debug=False, vis=False):
    env.reset(seed=seed)
    planner = PandaArmMotionPlanningSolver(
        env,
        debug=debug,
...
def solve_pullcubetool_marble(env: PullCubeToolEnv_marble, seed=None, debug=False, vis=False):
    env.reset(seed=seed)
    planner = PandaArmMotionPlanningSolver(
        env,
        debug=debug,
