...
@register_env("SpinStack-v1", max_episode_steps=200)
class SpinStackEnv(BaseEnv):
    """
    Task Description
    ----------------
...
@register_env("SpinStack-gen1", max_episode_steps=200)
class SpinStackEnv_gen1(BaseEnv):
...
@register_env("SpinStack-gen2", max_episode_steps=200)
class SpinStackEnv_gen2(BaseEnv):
