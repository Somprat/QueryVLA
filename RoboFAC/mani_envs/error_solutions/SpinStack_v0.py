...
def add_perturbation(task_stage, pose, gripper_state=None, perturbation_type="position_offset"):
    ...
    if task_stage == "cubeA_grasp":
        ...
        if perturbation_type == "position_offset":
            ...
            error_description["stage"] = "cubeB_grasp"
            error_description["error_type"] = "position offset"
        ...
        if perturbation_type == "speed_offset":
            ...
            error_description["error_type"] = "gripper_error"
            error_description["details"] = "The robot arm did not grasp the light green long block tightly enough, causing it to slip during the lift phase and ultimately failing to stack it upright on the red cube.",
            error_description["correction_suggestion"] = "Increase the gripper's grasping force to securely hold the light green long block and ensure it is lifted properly to stack it upright on the red cube."
