...
ERROR_DESCRIPTIONS = get_error_descriptions(objectA="red can", objectB="blue can")
...
def solve_with_errors(env: StackCubeEnv_can, log_file, error_stage, perturbation_type="position_offset", seed=None, debug=False, vis=False):
    env.reset(seed=seed)
    logs = []
    success_level = ""
...
if __name__ == '__main__':
    # quickstart
    env = gym.make(
        "StackCube-can", # there are more tasks e.g. "PushCube-v1", "PegInsertionSide-v1", ...
        num_envs=1,
    ...
    for seed in range(10):
        ...
        # res = solve_stackcube_can(env,vis=True)
        print(res)
    #   break
    # seed = 5
    # p = 0
