...
ERROR_DESCRIPTIONS = get_error_descriptions(object="block")
...
#     for contact in contacts:
#         if (contact.entity0 == entity1 and contact.entity1 == entity2) or (contact.entity0 == entity2 and contact.entity1 == entity1):
#             return True
#     return False
...
if __name__ == '__main__':
    # quickstart
    env = gym.make(
        "PullCube-block", # there are more tasks e.g. "PushCube-v1", "PegInsertionSide-v1", ...
        num_envs=1,
    ...
    for seed in range(5):
            res = solve_with_errors(env,log_file='close_gripper',error_stage="close_gripper", seed=seed, debug=False, vis=True)
            time.sleep(1)
    print(res[-1])
    env.close()