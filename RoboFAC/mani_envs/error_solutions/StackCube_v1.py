...
ERROR_DESCRIPTIONS = get_error_descriptions(objectA="red cube", objectB="green cube")
...
def add_perturbation(task_stage, pose, gripper_state=None, perturbation_type="position_offset"):
    ...
    if task_stage == "reach":
        ...
        error_description["error_type"] = "iposition offset"
...
def solve_with_errors(env: StackCubeEnv, log_file, error_stage, perturbation_type="position_offset", seed=None, debug=False, vis=False):
    env.reset(seed=seed)
    logs = []
    success_level = ""
...
if __name__ == '__main__':
    # quickstart
    env = gym.make(
        "StackCube", # there are more tasks e.g. "PushCube-v1", "PegInsertionSide-v1", ...
        num_envs=1,
    ...
    for seed in range(10):
      res = solve_with_errors(env, log_file=log_file,error_stage='grasp',perturbation_type="gripper_error", seed=seed,vis=True)
      print(res)
    #   break
    # seed = 5
    # p = 0
